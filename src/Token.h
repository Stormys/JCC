...
public:
	static enum Kind { SUBASSIGN, ADDASSIGN, MULASSIGN, DIVASSIGN, MODASSIGN, LOGICAL_NOT, NOT_EQUAL, LESS_THAN, LESS_THAN_EQUAL, GREATER_THAN, GREATER_THAN_EQUAL,
		...
		DOUBLE,STRUCT,INT,IF, VOID, OPEN_PAREN, CLOSE_PAREN, OPEN_CURLY, CLOSE_CURLY, SEMICOLON, RETURN, ADD, SUBTRACT,
		DIVIDE, MULTIPLY, ASSIGN, MODULUS, INCREMENT, DECREMENT,
		IDENTIFIER, INTEGER, ERROR1, E0F
	} Type;
